...
// ============================================================
// Shown when a user clicks "Select This Carrier" on the
// results page. Captures their contact info as a lead.
// No real payment is taken — this is Phase 1 demo only.
// ============================================================
...
// Helper: add days to a date string and return a formatted date
      ...
      <main className="page">
        <div className="confirmation-box">
          ...
          <p className="confirmation-note">
            A confirmation has been noted. No payment is required today.
          </p>
    ...
    <main className="page">
      ...
      <div className="booking-section">
        ...
        <div className="summary-grid">
          ...
          <div className="summary-item">
            ...
            <span className="summary-value">{new Date(quoteRequest.shipDate).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</span>
          </div>
          <div className="summary-item">
            <span className="summary-label">Est. Delivery</span>
            <span className="summary-value" style={{ color: '#1a73e8', fontWeight: '600' }}>{estimatedDelivery}</span>
          </div>
        </div>
      </div>
      ...
      <div className="booking-section">
        ...
        <div className="pricing-table">
          ...
          <div className="pricing-row">
            <span>Insurance coverage (up to ${carrier.insuranceUSD.toLocaleString()})</span>
            <span>Included</span>
          </div>
          <div className="pricing-row">
      ...
      {/* AI explanation */}
      <div className="ai-explanation" style={{ marginBottom: '2rem' }}>
      ...
      <div className="booking-section">
        ...
        <p style={{ color: '#555', marginBottom: '1.25rem' }}>
          Enter your contact info and we'll be in touch within 24 hours. No payment required today.
        </p>
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn-primary" disabled={loading}>
            {loading ? 'Submitting...' : 'Request This Carrier — No Payment Today'}
          </button>
        </form>
      </div>
